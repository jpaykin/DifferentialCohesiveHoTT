...
\begin{document}
\maketitle
\todo{Add emails and affiliation}
...
\begin{center}
  ...
  \end{tikzpicture}
\end{center}
\caption{Adjunctions. \todo{use colors to distinguish real-cohesive vs
    differential-cohesive modalities. Also include the quadruple adjoint
    functors between different categories of spaces.} The inclusion symbols in
