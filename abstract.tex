...
For example, in \cite{SatiSchreiberStasheff2012} spaces locally modeled on a 6-type are important, 
which is supported by a fragment of differential cohesive homotopy type theory used in \cite{Wellen2017}.
